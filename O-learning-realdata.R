...
write.csv(lol_dose_hat, "results/realdata/lol-real-dose-Y2.csv", row.names = FALSE)
write.csv(kol_dose_hat, "results/realdata/kol-real-dose-Y2.csv", row.names = FALSE)
...
for (i in 1:200){
  ...
  write.csv(lol_value_hat, "results/realdata/lol-real-value-Y2.csv", row.names = FALSE)
  ...
  #write.csv(kol_value_hat, "results/realdata/kol-real-value-Y2.csv", row.names = FALSE)
}
